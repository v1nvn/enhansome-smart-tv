# Awesome Smart TV [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,153 | 🐛 68 | 📅 2026-01-28 with stars
...
* [homebridge-samsung-tizen](https://github.com/tavicu/homebridge-samsung-tizen) ⭐ 676 | 🐛 88 | 🌐 JavaScript | 📅 2026-01-29 - A plugin for [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,209 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-08 that allows you to control your Samsung Tizen TV with HomeKit and Siri (JavaScript).
...
* [homebridge-samsungtv2016](https://github.com/kyleaa/homebridge-samsungtv2016) ⭐ 57 | 🐛 3 | 🌐 JavaScript | 📅 2017-01-14 - A plugin for [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,209 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-08 that allows you to control your 2016 Samsung TV with HomeKit and Siri (JavaScript).
...
* \[TizenTube] (<https://github.com/reisxd/TizenTube> ⭐ 1,429 | 🐛 53 | 🌐 JavaScript | 📅 2026-02-04) - A TizenBrew module that enhances your favourite streaming websites viewing experience by removing ads and adding support for Sponsorblock.
* \[TizenBrew] (<https://github.com/reisxd/TizenBrew> ⭐ 1,180 | 🐛 11 | 🌐 JavaScript | 📅 2026-01-11) - A way to experience modded websites and you can install newer apps without fighting with Tizen Studio
...
* [homebridge-webos-tv](https://github.com/merdok/homebridge-webos-tv) ⭐ 696 | 🐛 31 | 🌐 JavaScript | 📅 2025-12-26 - A plugin for [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,209 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-08 which allows you to control your webOS TV.
...
Feel free to share your experience and contribute useful extension resources by creating [new issue](https://github.com/vitalets/awesome-smart-tv/issues) ⭐ 1,283 | 🐛 2 | 📅 2025-05-13 or [pull request](https://github.com/vitalets/awesome-smart-tv/pulls) ⭐ 1,283 | 🐛 2 | 📅 2025-05-13.
