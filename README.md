...
* [homebridge-samsung-tizen](https://github.com/tavicu/homebridge-samsung-tizen) ⭐ 676 | 🐛 88 | 🌐 JavaScript | 📅 2026-01-29 - A plugin for [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,210 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-08 that allows you to control your Samsung Tizen TV with HomeKit and Siri (JavaScript).
...
Feel free to share your experience and contribute useful extension resources by creating [new issue](https://github.com/vitalets/awesome-smart-tv/issues) ⭐ 1,284 | 🐛 2 | 📅 2025-05-13 or [pull request](https://github.com/vitalets/awesome-smart-tv/pulls) ⭐ 1,284 | 🐛 2 | 📅 2025-05-13.
